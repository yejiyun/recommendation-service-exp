    ...
    <div id="nav">
      <div id="wrapper">
        <div id="columns" align="center">
          ...
          ?>
		  <hr>
				<input type="button" class = "btn" onclick="location.href='https://docs.google.com/forms/d/1kFX6qkNXr07tw8ygbkeElq-82SXC4Ky8dSNAVni9mBI/viewform?usp=send_form';" value="다음" />
		  <hr>
        </div>
      </div>
    </div>
